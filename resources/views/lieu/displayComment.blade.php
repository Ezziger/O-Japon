            ...
            <form method="post" action="{{ route('commentaires.store') }}" @if ($commentaire->parent_id > 1) style="display: none;" @endif>
                ...
                <div class="commentaireForm">
                    ...
                    <div class="commentaireBtn">
                        ...
                        <form id="formEdit" method="post" action="{{route('commentaires.update', $commentaire)}}" style="display: none;">
                ...
                <div class="form-group d-flex justify-content-end mt-2">
                    <input type="submit" class="btn btn-dark" value="Enregister vos modifications" />
                </div>
            </form>
